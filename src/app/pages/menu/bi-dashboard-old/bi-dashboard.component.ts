...
import { TopPageModel,browserModel } from './bi-dashboard.model';
import { InstructorModel } from './bi-dashboard.model';
...
export class BiDashboardComponent {
  ...
  ngOnInit(): void {
    ...
    */
    ...
    this._areasplineChart('["#E8A2CF", "#EAB676","#1E81B0","#CFBDF3","#E4D58D","#C8A6A9","#F6A8AE"]');
    this._simplePieChart('["#C8A6A9","#F6A8AE","#E4D58D","#CFBDF3","#118DFF","#1E81B0","#EAB676","#76B5C5","#ABDBE3","#BCEA91","#C8A6A9","#F5C4AF"]');
    this._underPerformingServices('["#C8A6A9","#F6A8AE","#E4D58D","#CFBDF3","#118DFF","#1E81B0","#EAB676","#76B5C5","#ABDBE3","#BCEA91","#C8A6A9","#F5C4AF"]')
...
public updateOptions(option: any): void {
  ...
  private _areasplineChart(colors: any) {
    ...
    this.areasplineChart = {
      ...
      {
        name: 'APA',
        data: [50, 55, 50, 56, 57, 80, 99, 120, 80, 90]
      },
      {
        name: 'ASME',
        data: [72, 52, 38, 39, 43, 45, 27, 54, 42, 33]
      },
      {
        name: 'ASCE',
        data: [39, 53, 42, 56, 69, 83, 92, 134, 100, 78]
      },
      {
        name: 'CUP',
        data: [23, 24, 68, 84, 62, 82, 56, 12, 124, 131]
      },
      {
        name: 'EUP',
  ...
  */
  private _simplePieChart(colors: any) {
    ...
    this.UnderperformingPublishersPieChart = {
      series: [10,10,10,10,10,10,10, 8,8,5,3,3,3,3],

      chart: {
        height: 300,
        type: "pie",
      },
      labels: ["AIP","ASCE","ASME","CUP","OUP","RSC","SAGE","FRONTIERS","APA","TnF","SFN","COB","IWAP","EUP"],
      legend: {
        position: "bottom",
      },
      dataLabels: {
  ...
  * Simple Pie Chart
  */
  private _underPerformingServices(colors: any) {
    colors = this.getChartColorsArray(colors);
    this.UnderPerformingServicesPieChart = {
      series: [10,10,10,10,8,8,5,3,3],

      chart: {
        height: 300,
        type: "pie",
      },
      labels: ["Account Management","Communication","Customer Satisfaction","Feedback","Overall Performance","Publication Speed","Quality","Schedule","RFT"],
      legend: {
        position: "bottom",
      },
      dataLabels: {
