...
export class KpiConfigComponent implements OnInit {
  ...
  addKpiConfig() {
    ...
    let biPublisherConfig = {
      ...
      overallPerfomanceMetrics: $('#overallPerfomanceMetrics').val() == "" ? null : $('#overallPerfomanceMetrics').val(),
      scheduleMetrics: $('#scheduleMetrics').val() == "" ? null : $('#scheduleMetrics').val(),
      qualityMetrics: $('#qualityMetrics').val() == "" ? null : $('#qualityMetrics').val(),
      communicationMetrics: $('#communicationMetrics').val() == "" ? null : $('#communicationMetrics').val(),
      customerSatisfactionMetrics: $('#customerSatisfactionMetrics').val() == "" ? null : $('#customerSatisfactionMetrics').val(),
      accountManagementMetrics: $('#accountManagementMetrics').val() == "" ? null : $('#accountManagementMetrics').val(),
      rftMetrics: $('#rftMetrics').val() == "" ? null : $('#rftMetrics').val(),
      publicationSpeedMetrics: $('#publicationSpeedMetrics').val() == "" ? null : $('#publicationSpeedMetrics').val(),
      feedbackMetrics: $('#feedbackMetrics').val() == "" ? null : $('#feedbackMetrics').val(),
      authorsatisficationMetrics: $('#authorsatisficationMetrics').val() == "" ? null : $('#authorsatisficationMetrics').val(),
      overallPerfomanceAction: $('#overallPerfomanceAction').val() == null ? null : $('#overallPerfomanceAction').val(),
      scheduleAction: $('#scheduleAction').val() == null ? null : $('#scheduleAction').val(),
      qualityAction: $('#qualityAction').val() == null ? null : $('#qualityAction').val(),
      communicationAction: $('#communicationAction').val() == null ? null : $('#communicationAction').val(),
      customerSatisfactionAction: $('#customerSatisfactionAction').val() == null ? null : $('#customerSatisfactionAction').val(),
      accountManagementAction: $('#accountManagementAction').val() == null ? null : $('#accountManagementAction').val(),
      rftAction: $('#rftAction').val() == null ? null : $('#rftAction').val(),
      publicationSpeedAction: $('#publicationSpeedAction').val() == null ? null : $('#publicationSpeedAction').val(),
      feedbackAction: $('#feedbackAction').val() == null ? null : $('#feedbackAction').val(),
      authorsatisficationAction: $('#authorsatisficationAction').val() == null ? null : $('#authorsatisficationAction').val()
    }
