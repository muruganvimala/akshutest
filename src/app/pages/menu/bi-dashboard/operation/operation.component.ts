...
chartaggregatetype : string = 'bar';

UnderPerformingServicescharttype : string = 'pie';

UnderperformingPublishercharttype : string = 'radar';

LeadingReliableContributorscharttype  : string = 'bar';

ConsistentlyPerformingcharttype : string = 'polarArea';
...
isSortAscending: boolean = true;
 ...
 monthdatapublish: any[] =[] ;
 emonthdatapublish:any[] = []; 
 comparisonarray:any[]=[];
 ...
 public comparisonseries: any[]= []; 
 public SelectedMonths: any[]=["Mar 2023","Mar 2024"];
 public previoustitlemonthdata : any[] = [];
 SelectedPubcomparison : string =''; //= "Publisher";
 SelectedMetcomparison : string =''; //"Publisher";
 titleValue: any = 0;
 num: number = 0;
 ...
 currentpopup = 'UnderPerformingServicesPieChart';
 ...
 constructor(private apiService: ApiService, private cpService: ColorPickerService, private sweetAlert: SweetAlertService,private formBuilder: UntypedFormBuilder,private datePipe:DatePipe) {
   ...
   this.smonth ='Mar 2023';
   this.emonth='Mar 2024';
   var date = new Date();
 ...
 ngOnInit(): void {
   ...
   //document.getElementById("startDate").defaultValue = "Goofy";
   ...
   this.submitFilter('["#ABDBE3", "#f21f0c", "#EAB676","#1E81B0","#E8A2CF","#CFBDF3","#E4D58D","#F6A8AE","#F6A8AE"]');
   //this.onemonthaggregate();
...
closemodal()
{
 ...
 ComparisonChart()
 {
   console.log('In ComparisonChart');
    var ds = document.getElementById('FormMonth');
    console.log($('#FormMonth').val());
...
getmonthdata(m : string) : any
{
 
 this.apiService.GetDataWithToken('api/dashboard/LastMonthChart?sMonthyear='+m+'&eMonthyear='+m+'')
 .subscribe(
   res => {
        console.log('monthly data of comperison',res.data);
        var sx = res.data;
     for(let j=0;j<sx.length; j++)
     {
       this.monthdatapublish.push(sx[j]);
     }
        //this.monthdatapublish = res.data;
        var md = res.data;
       return md;
   });
}
...
StartmonthChange() {
 console.log('Inpout text change event:',this.smonth);
 console.log(this.datePipe.transform(this.smonth,"MMM yyyy"));
 //this.smonth = '';
 this.smonth = this.datePipe.transform(this.smonth,"MMM yyyy") as string;
 this.submitFilter('["#ABDBE3", "#f21f0c", "#EAB676","#1E81B0","#E8A2CF","#CFBDF3","#E4D58D","#F6A8AE","#F6A8AE"]');
}

EndmonthChange()
{
 console.log('Inpout text change event:',this.emonth);
 console.log(this.datePipe.transform(this.emonth,"MMM yyyy"));
 this.emonth = this.datePipe.transform(this.emonth,"MMM yyyy") as string;
 this.submitFilter('["#ABDBE3", "#f21f0c", "#EAB676","#1E81B0","#E8A2CF","#CFBDF3","#E4D58D","#F6A8AE","#F6A8AE"]');
}
...
publisherchange()
{
 var sds  = $('#PubFilter').val();
  console.log('In Pub change',sds);
  this.SelectedPubcomparison = sds;

  if(this.monthdatapublish.length > 0)
  {
   ...
   this.series = [];
       ...
       console.log('In comp main data log:',this.monthdatapublish.length);
       var __result = this.monthdatapublish.map(function(a) {return a.monthYear});
       //console.log('In comp main data log monthYear Array: ', __result);
   
       let monthYearPushArray = [];
   for(let i = 0; i < __result.length ; i++){
     if(monthYearPushArray.indexOf(__result[i]) === -1) {
       monthYearPushArray.push(__result[i]);
     } else {
       //console.log(`${result[i]} is already pushed into array`);
     }
   }
   
      //console.log(' ', monthYearPushArray)
   
   
   var resultpublisherName = this.monthdatapublish.map(function(a) {return a.publisherName;});
   
   console.log('resultpublisherName:',resultpublisherName);
   ...
   {
     this.publisherList = publisherNamePushArray;
   }
   

   if(this.SelectedPubcomparison != '')
   {
     //console.log('Befor selection',publisherNamePushArray);
     var pub = this.SelectedPubcomparison;
     //publisherNamePushArray.pop(pub);
     publisherNamePushArray = [];
     publisherNamePushArray.push(pub);
   
   }


   //console.log('Final comprison publisherName Array: ', publisherNamePushArray)
   
   
   var resultmetrics = this.monthdatapublish.map(function(a) {return a.metrics;});
   ...
   {
     this.metricsList = metricsPushArray;  
   }
   
    if(this.SelectedMetcomparison != '')
   {
     //console.log('Befor selection',metricsPushArray);
     var met = this.SelectedMetcomparison;
     //publisherNamePushArray.pop(pub);
     metricsPushArray = [];
     metricsPushArray.push(met);
 
   }
   
   //console.log('in Compersions Final metrics Array: ', metricsPushArray)
   ...
   for(let m=0; m < metricsPushArray.length; m++)
   {
          ...
          for(let p = 0; p < publisherNamePushArray.length ; p++)
          {
               ...
               var ddddd =   this.monthdatapublish.filter(person => person.metrics == metrics && person.publisherName == publisherName);
           ...
           let modifiedMonth = { name: metricsPushArray[m], type: "bar",data:nums };
   ...
   for(let m=0; m < metricsPushArray.length; m++)
   {
     ...
     for(let my=0; my< monthYearPushArray.length; my++)
     {
       ...
       var _ddddd =   this.monthdatapublish.filter(person => person.metrics == _metrics && person.monthYear == _my);
   ...
   for(let my=0; my< monthYearPushArray.length; my++)
   {
     let modifiedgroups = { title: monthYearPushArray[my], cols:  publisherNamePushArray.length };
     //this.categories.push(monthYearPushArray[my]);
     this.groups.push(modifiedgroups);
     for(let p = 0; p < publisherNamePushArray.length ; p++)
     {
       this.categories.push(publisherNamePushArray[p]);
     }
   }

     console.log('this.series:',this.series);

    this._lineColumnAreaChart('["#008FFB","#f21f0c","#CFBDF3","#118DFF","#1E81B0","#EAB676","#76B5C5","#ABDBE3","#BCEA91","#C8A6A9","#F5C4AF"]', this.series,this.categories,this.groups);
...
Metricschange(){
 var sds  = $('#MetFilter').val();
  console.log('In Met change',sds);
  this.SelectedMetcomparison = sds;
 ...
 submitFilter(colors: any) {
   this.groups = [];
   this.categories = [];
   //this.metricsList = [];
   //this.publisherList = [];
   this.series = [];
   this.monthdatapublish = [];
   this.emonthdatapublish = [];
   //console.log('In submit filter');
    //console.log($('#startDate').val());
    //console.log($('#endDate').val());
    //this.previousMMYY = $('#startDate').val();
    //this.currentMMYY = $('#endDate').val()
    //let monthdata : any[] = [this.SelectedMonths.length];
   // let plist :any[]=[];
   // let combined : any;
   //  let monthdata: any[] = new Array(this.SelectedMonths.length);
   var sm = this.smonth;  //$('#startDate').val();
   var em = this.emonth;  //$('#endDate').val()

//console.log('this.smonth',this.smonth);
//console.log('this.emonth',this.emonth);



   this.apiService.GetDataWithToken('api/dashboard/Comparisoncharts?sMonthyear='+sm+'&eMonthyear='+em+'')
   .subscribe(
     res => {
          console.log('Comparisoncharts data:',res.data);
          this.monthdatapublish=res.data;
          

         //this.emonthdatapublish.push(res.data);
          //var sx = res.data;
       // for(let j=0;j<sx.length; j++)
       // {
       //   this.monthdatapublish.push(sx[j]);
       ...
       // this.monthdatapublish.forEach((item, row) => {
       //   this.comparisonarray.push(item);
       // });
      

       // this.emonthdatapublish.forEach((item, row) => {
       //   this.comparisonarray.push(item);
       // });
      
       // this.monthdatapublish.forEach((item, row) => {
       //   let find = this.emonthdatapublish.find((element) => {
       //     return item.id===element.id
       //   });

       //   if (find) this.comparisonarray.push(Object.assign({},item,find));
       // });

        //this.comparisonarray =  this.monthdatapublish.concat(this.emonthdatapublish)
       //this.emonthdatapublish.concat(this.monthdatapublish);
          //this.monthdatapublish = res.data;
         //  var md = res.data;
         // return md;
         //this.comparisonarray = this.monthdatapublish; // + this.emonthdatapublish;
         //console.log('Concat data:', this.comparisonarray.concat(this.emonthdatapublish));
   ...
   if(this.SelectedPubcomparison != '')
   {
     ...
     publisherNamePushArray = [];
     publisherNamePushArray.push(pub);
    //var pindex = publisherNamePushArray.indexOf(pub);
     //publisherNamePushArray.splice(pindex, 1);
     //console.log('After selection',publisherNamePushArray);
   }
    ...
    if(this.SelectedMetcomparison != '')
   {
     ...
     metricsPushArray = [];
     metricsPushArray.push(met);
    //var pindex = metricsPushArray.indexOf(met);
    //metricsPushArray.splice(pindex, 1);
     //console.log('After selection',metricsPushArray);
   }
   ...
   for(let m=0; m < metricsPushArray.length; m++)
   {
          ...
          for(let p = 0; p < publisherNamePushArray.length ; p++)
          {
           ...
           //var _ddddd =   this.monthdatapublish.filter(person => person.metrics == metrics );
           //var tar =   _ddddd[0];
  ...
  //["#008FFB","#E4D58D","#CFBDF3","#118DFF","#1E81B0","#EAB676","#76B5C5","#ABDBE3","#BCEA91","#C8A6A9","#F5C4AF"]
  //console.log('Comparison serise data:',plist);
  
  //this._basicChart('["#008FFB","#E4D58D","#CFBDF3","#118DFF","#1E81B0","#EAB676","#76B5C5","#ABDBE3","#BCEA91","#C8A6A9","#F5C4AF"]',this.comparisonseries);
...
// Chart Colors Set
 ...
 private _basicChart(colors: any, comdata? : any) {
   colors = this.getChartColorsArray(colors);
   this.basicChart = {
     series: comdata,
     chart: {
   ...
   const observer = new MutationObserver(() => {
     this._basicChart('["#008FFB","#E4D58D","#CFBDF3","#118DFF","#1E81B0","#EAB676","#76B5C5","#ABDBE3","#BCEA91","#C8A6A9","#F5C4AF"]');
   });
   observer.observe(document.documentElement, {
     attributes: true,
     attributeFilter: [attributeToMonitor]
 ...
 */
 ...
 fullscreen() {
   const chartContainer = document.getElementById('UnderPerformingServicesPieChart');
   //console.log(id);
   if (!chartContainer) {
     console.error(`Element with id UnderPerformingServicesPieChart not found`);
     return;
 }
 const originalParent = chartContainer.parentElement;
  //html: ''+id?.innerHTML+'',
   Swal.fire({
     ...
     html:`<div id="fullscreenChartContainer" style="width: 100%; height: 100%;"></div>`, 
...
// }
 ...
 fullscreenUnderperformingPublishers()
 {
   //this.showModal?.show();
   // this.currentpopup = 'UnderperformingPublishersPieChart';
   // var id = document.getElementById('UnderperformingPublishersPieChart');
   // //console.log(id);

   
   // Swal.fire({
   //   title: 'Underperforming Publishers!',
   //   html: ''+id?.innerHTML+'',
   //   showCloseButton: true
   // });

   const chartContainer = document.getElementById('UnderperformingPublishersPieChart');
   //console.log(id);
   if (!chartContainer) {
     console.error(`Element with id UnderperformingPublishersPieChart not found`);
     return;
 }
 const originalParent = chartContainer.parentElement;
  //html: ''+id?.innerHTML+'',
 ...
 fullscreenPyramid()
 {
   // var id = document.getElementById('Pyramid');
   // console.log(id);
   ...
   const chartContainer = document.getElementById('Pyramid');
   //console.log(id);
   if (!chartContainer) {
     console.error(`Element with id Pyramid not found`);
     return;
 }
 const originalParent = chartContainer.parentElement;
  //html: ''+id?.innerHTML+'',
 ...
 fullscreensimpleDonutChart()
 {
   // var id = document.getElementById('simpleDonutChart');
   // console.log(id);

   
   // Swal.fire({
   //   title: 'Consistently Performing!',
   //   html: ''+id?.innerHTML+'',
   //   showCloseButton: true
   // });

   const chartContainer = document.getElementById('simpleDonutChart');
   //console.log(id);
   if (!chartContainer) {
     console.error(`Element with id simpleDonutChart not found`);
     return;
 }
 const originalParent = chartContainer.parentElement;
  //html: ''+id?.innerHTML+'',
  ...
  */
   ...
   * Simple Pie Chart
   */
 public _UnderperformingServices(colors: any,smonth?: string, emonth?: string) {
 ...
 public UnderperformingServicescharttype(type: string)
 {
    ...
    {
     console.log('chart UnderperformingPublishersvaluemonthselection',this.UnderperformingPublishersvaluemonthselection);
...
////// paramiters colors: any,smonth?: string, emonth?: string
 ...
 private __UnderPerformingServices(colors: any,chartdata?: any)
 {
     ...
     else if (this.UnderPerformingServicescharttype == 'radialBar')
     {
       this.UnderPerformingServicesPieChart = {
         series: resultcount,
         chart: {
     ...
     // else if (this.UnderPerformingServicescharttype == 'funnel')
     // {
     //   this.UnderPerformingServicesPieChart = {
     //     series: [
     //       {
     ...
     //   };
     // }
     else if (this.UnderPerformingServicescharttype == 'line')
     {
     ...
     {
       //console.log('UnderPerformingServicescharttype:',this.UnderPerformingServicescharttype);
       // this.UnderPerformingServicesPieChart = {
       //   series: [{
       //     data:resultcount
       //   }
 ...
 private __UnderperformingPublishers(colors: any,chartdata?: any)
 {
     ...
     console.log('IN __UnderperformingPublishers',resultPublisher);
     ...
     else if (this.UnderperformingPublishercharttype == 'radialBar')
     {
       this.UnderperformingPublishersPieChart = {
         series: resultcount,
     chart: {
     ...
     else if (this.UnderperformingPublishercharttype == 'line')
     {
       console.log('chart type:',this.UnderperformingPublishersPieChart);
     ...
     else
     {
       ...
       //   colors: colors,
       // };
       //this.UnderperformingPublishercharttype,
     ...
     console.log('IN UnderperformingPublishersPieChart:',this.UnderperformingPublishercharttype);
 ...
 private __LeadingReliableContributors(colors: any,chartdata?: any)
 {
     ...
     else if (this.LeadingReliableContributorscharttype == 'radialBar')
     {
       this.Pyramid = {
         series: resultcount,
     chart: {
     ...
     else if (this.LeadingReliableContributorscharttype == 'line')
     {
 ...
 private __ConsistentlyPerforming(colors: any,chartdata?: any)
 {
     ...
     else if (this.ConsistentlyPerformingcharttype == 'line')
     {
 ...
 */
  public _lineColumnAreaChart(colors: any,chartdata ?: any, categories?: any, group?: any) {
  
   // this.categories.push('Mar 2023');
   // this.categories.push('Mar 2024');
   colors = this.getChartColorsArray(colors);
 ...
 getKPIData(): void {
   ...
   //this.getKPIConfigData();
   this.apiService.GetDataWithToken('api/User/KPIDataDisplaybyConfig').subscribe(
     (kpiList) => {
...
getKPIConfigData(): void {
 this.apiService.GetDataWithToken('api/PublisherConfig/Display').subscribe(
   (Response) => {
...
private _clicksChartnew(colors: any, _actualdata?:  any , _targetdata?: any ,_publishernamenew?: any ) {
 ...
 if(this.chartaggregatetype == "bar")
 {
 ...
 else if(this.chartaggregatetype == "area")
 {
   this.clicksChart = {
     series: [{
       name: 'Actual',
 ...
 else if(this.chartaggregatetype == "line")
 {
   this.clicksChart = {
     series: [{
       name: 'Target',
 ...
 else if(this.chartaggregatetype == 'scatter')
 {
   this.clicksChart = {
     series: [{
       name: 'Target',
...
console.log('in method', colors);
 colors = this.getChartColorsArray(colors);
 var optimalColumnWidthPercent = 20 + (60 / (1 + 30*Math.exp(-_publishernamenew.length /3)));
 ...
 const observer = new MutationObserver(() => {
   this._pageoverviewChartnewvaluefirstmonth('["#F6A8AE","#C8A6A9"]');
 });
 observer.observe(document.documentElement, {
   attributes: true,
   attributeFilter: [attributeToMonitor]
   ...
   res => {
     ...
     setTimeout(() => {
      if(this.titleonemonthdata.length > 0)
      {
       ...
       console.log('one month data 1:',onemonthdata);
       var result = onemonthdata.map(function(a) {return a.monthYear;});
        ...
        this.titleValue =String((overallofonemonth/publisherNamePushArray.length).toFixed(3));
       ...
       // }
        ...
        this.titelmonthvaluearray.push(this.titleValue);
        this.titelmontharray.push(_my.slice(0,3));
...
KPIthreemonth()
{
 ...
 .subscribe(
   res => {
     console.log('One month data quarter',res.data);
     this.titleonemonthdata = res.data;
     ...
     setTimeout(() => {
       ...
       {
         var overallofonemonth=0;
         var threevmonth= this.titleonemonthdata;
         console.log('two month data',threevmonth);
         var result = threevmonth.map(function(a) {return a.monthYear;});
  ...
  console.log('Final monthYear Array  one month: ', monthYearPushArray)
    ...
    var resultpublisherName = threevmonth.map(function(a) {return a.publisherName;});
  ...
  var resultmetrics = threevmonth.map(function(a) {return a.metrics;});
  ...
  console.log('Final metrics Array one month: ', metricsPushArray)
     ...
     {
       var publisher = publisherNamePushArray[o];
       var _ddddd =   threevmonth.filter(person => person.publisherName == publisher);
       var actualdata = 0;
       var tagetdata =0;
       var monthname= "";
       ...
       for(let m=0; m< monthYearPushArray.length; m++)
       {
          ...
          //var cal = actualdata/_ddddd.length;
          //this.titelmonthvaluearray.push((cal).toFixed(2)); // (s2).toFixed(3) 

         
          //overallofonemonth =  overallofonemonth + (cal);
          ...
          monthwisedatatarget = _monthwisedatatarget;
             ...
             //var sd = ((monthwisedataactual/publisherNamePushArray.length)/monthYearPushArray.length);
             //console.log('month wise box data calculation',monthname, sd);
               
       }

       console.log('month wise value data calculation monthname:',monthname, monthwisedataactual/monthYearPushArray.length);
       var valuetype = actualdata/_ddddd.length;
     ...
     for(let v=0; v< monthYearPushArray.length; v++)
     {
       ...
       var _monthYear =   threevmonth.filter(person => person.monthYear == mmyyyy);
       var  monthtotal=0;



       var resultm = _monthYear.map(function(a) {return a.metrics;});
       ...
       var resultpublisherName = _monthYear.map(function(a) {return a.publisherName;});
       ...
       //console.log(`${result[i]} is already pushed into array`);
         ...
         var cal =(((monthtotal/publisherNamePushArray.length)));
         //var s1 = cal/monthYearPushArray.length
         //var s2 = s1/metricsPushArray.length;
         this.titelmonthvaluearray.push(cal/publisherNamePushArray.length); //.toFixed(2)); // (s2).toFixed(3) 

         //overallofonemonth =  overallofonemonth + (cal/publisherNamePushArray.length);
         //overallofonemonth = overallofonemonth + s2;
         this.titelmontharray.push(mmyyyy.slice(0,3)); //charAt(0,3));
         console.log("monthwise data of chart:",mmyyyy,monthtotal);
     ...
     const _statData = 
      ...
      console.log('overall KPI:', this.Overalldata);
       this.newstatData = this.Overalldata;
console.log('month with cal:',this.titelmonthvaluearray,this.titelmontharray);
       this.Titlechart(this.titelmonthvaluearray,this.titelmontharray);
     // var _publisherName = this.threemonthvaluedata.map(function(a) {return a.publishername;});
     // var _resultvalue = this.threemonthvaluedata.map(function(a) {return a.data;});
     // var _targetvalue = this.threemonthvaluedata.map(function(a) {return a.targetvalue;});
    ...
    console.log('Final metrics Array one month: ', metricsPushArray)
       ...
       for(let o=0; o< publisherNamePushArray.length; o++)
       {
         ...
         for(let m=0; m< monthYearPushArray.length; m++)
         {
          ...
          console.log('month wise value data calculation:',monthname, actualdata);
          monthwisedataactual =  _monthwisedata;
          monthwisedatatarget = _monthwisedatatarget;
         ...
         overallofonemonth = overallofonemonth + Math.round(monthwisedataactual);
         console.log('two publisher box of six month wise data:',targetall);
     ...
     for(let v=0; v< monthYearPushArray.length; v++)
     {
       ...
       // }
         ...
         var s3 = monthtotal/metricsPushArray.length;
         var s4= s3/monthYearPushArray.length;
         //this.titelmonthvaluearray.push((s2).toFixed(3)); //(cal/publisherNamePushArray.length).toFixed(2));
         ...
         this.titelmontharray.push(mmyyyy.slice(0,3));
         console.log("monthwise data of chart:",mmyyyy,monthtotal);
    ...
    console.log('Final metrics Array one month: ', metricsPushArray)
     ...
     for(let v=0; v< monthYearPushArray.length; v++)
     {
       ...
       var  monthtotal=0;
         ...
         //this.titelmonthvaluearray.push((monthtotal/publisherNamePushArray.length).toFixed(2));
         this.titelmontharray.push(mmyyyy.slice(0,2));
...
{
console.log('Titlechart:', valuedata, monthcat);
   ...
   var result = tvmonth.map(function(a) {return a.monthYear;});
    ...
    console.log('Final metrics Array one month: ', metricsPushArray)
       ...
       for(let o=0; o< publisherNamePushArray.length; o++)
       {
         ...
         var monthwisedataactual = 0;
         var monthwisedatatarget = 0;
           console.log('Three publisher wise data:',_ddddd);
         ...
         for(let o=0; o< publisherNamePushArray.length; o++)
         {
           ...
           for(let m=0; m< monthYearPushArray.length; m++)
           {
               ...
               if(monthwise.length > 0)
               {
                 ...
                 _monthwisedatatarget = _monthwisedatatarget + targetdata/metricsPushArray2.length;
                 _monthwisedata = _monthwisedata + actualdata/metricsPushArray2.length;
        ...
        if(this.aggregatewiseonemonth.length > 0)
        {
         ...
         var result = onemonthdata.map(function(a) {return a.monthYear;});
          ...
          for(let o=0; o< publisherNamePushArray.length; o++)
          {
            ...
            for(let p=0; p< _ddddd.length; p++)
            {
                 actualdata =  actualdata + Number(_ddddd[p].percentage);
                 targetdata = targetdata + _ddddd[p].target;
            }
            var valuetype = actualdata/_ddddd.length;
            var targettype = targetdata/_ddddd.length;
       ...
       for(let o=0; o< publisherNamePushArray.length; o++)
       {
         ...
         for(let m=0; m< monthYearPushArray.length; m++)
         {
             ...
             if(monthwise.length > 0)
             {
               ...
               for(let f=0; f< monthwise.length; f++)
               {
                 actualdata =  actualdata + Number(monthwise[f].percentage); //monthwise[f].actual; 
                 tagetdata = tagetdata +  monthwise[f].target;
               }
