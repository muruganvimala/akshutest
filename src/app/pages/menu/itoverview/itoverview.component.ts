...
@Component({
  selector: 'app-itoverview',
  templateUrl: './itoverview.component.html',
  styleUrls: ['./itoverview.component.scss']
})
export class ItoverviewComponent {
  ...
  ngOnInit(): void {
    ...
    const countdownSeconds = 2600000;
