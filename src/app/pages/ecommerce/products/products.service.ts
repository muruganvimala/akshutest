...
function matches(country: productModel, term: string, pipe: PipeTransform) {
  return country.Publisher.toLowerCase().includes(term.toLowerCase())
    ...
    || country.PE.toLowerCase().includes(term.toLowerCase())
    || country.CE.toLowerCase().includes(term.toLowerCase())
    || country.Typesetting.toLowerCase().includes(term.toLowerCase())
    || country.ProjectManagement.toLowerCase().includes(term.toLowerCase())
    ;
}
