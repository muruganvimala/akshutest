...
import { productModel } from './publisher.model'; 

import { DecimalPipe } from '@angular/common';
import { debounceTime, delay, switchMap, tap } from 'rxjs/operators';
import { SortColumn, SortDirection } from './publisher-sortable.directive';
...
function matches(country: productModel, term: string, pipe: PipeTransform) {
  return country.acronym.toLowerCase().includes(term.toLowerCase())
